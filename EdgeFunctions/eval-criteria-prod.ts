...
This is the list of evaluation criterias: [Automation Skills, Programming & Scripting, Test Strategy & Execution, CI/CD & DevOps Integration, Metrics & Reporting, Collaboration & Communication, Problem Solving, Technical Knowledge, Experience Relevance, Cultural Fit, Product Management, Computer Architecture]. Make sure that one of these criterias are used up first. If there is any criteria which is not listed, only then use "Custom".
